...
public class MemberController {
	...
	public void insertMember(String userId, String userPwd, String userName, String gender, int age,
		...
		//---  MemberView.displaySuccess("회원가입에 성공했습니다.");
		//--- Cannot make a static reference to the non-static field 오류
		//--- 참조할 수 없는 이유는 컴파일 순서에서 찾을 수 있다.
		//--- 다른 멤버보다 static 멤버가 먼저 컴파일되기 때문에, static 멤버의 컴파일 시점에서는 static이 아닌 메서드나 필드는 정의되지 않았기 때문이다.
		//--- 따라서, 모든 메서드나 필드를 static 멤버로 바꾸거나 Wookoa 클래스의 객체를 직접 생성해서 접근하는 방법으로 우회해야 한다.
		//--- 출처: https://wookoa.tistory.com/80 [Wookoa:티스토리]
